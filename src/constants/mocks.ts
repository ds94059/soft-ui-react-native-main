...
export const FOLLOWING: IProduct[] = [
  {
    ...
    description: 'Sprayer',
    image: require('../assets/images/sprayer_2.png'),
  },
  {
    id: 2,
    type: 'vertical',
...
export const CATEGORIES: ICategory[] = [
  { id: 1, name: 'Popular', image: require('../assets/icons/office.png') },
  { id: 2, name: 'Newest', image: require('../assets/icons/home.png') },
  { id: 3, name: 'Fashion', image: require('../assets/icons/flight.png') },
  { id: 4, name: 'Best deal', image: require('../assets/icons/train.png') },
];
